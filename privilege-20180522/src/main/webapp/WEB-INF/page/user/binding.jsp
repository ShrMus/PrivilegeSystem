    ...
    <div class="blog-body">
        ...
        <div class="blog-container">
        	<blockquote class="layui-elem-quote sitemap layui-breadcrumb shadow">
                ...
                <a><cite>绑定已有账号 </cite></a>
            </blockquote>
            <div class="blog-main">
            	<div class="child-nav shadow">
                    <span class="child-nav-btn child-nav-btn-this">绑定已有账号 </span>
                </div>
				<div class="shadow" style="text-align:left;font-size:16px;padding:40px 240px;background:#fff;margin-bottom:15px;">
					...
					<form class="layui-form" action="${pageContext.request.contextPath}/user/binding">
						<input type="hidden" name="openid" value="${requestScope.openid}">
						<input type="hidden" name="nickname" value="${requestScope.nickname}">
						<input type="hidden" name="icon" value="${requestScope.icon}">
						<table class="layui-table" lay-size="lg" width="100%">
							...
							<tr>
								...
								<input class="layui-btn" type="submit" value="绑定"/>
								<a class="layui-btn" href="${pageContext.request.contextPath}/register.jsp">没有账号？去注册一个。</a>
								</td>
							</tr>
						</table>
					</form>
