        ...
        <div class="blog-container">
            ...
            <div class="blog-main">
            	<div class="child-nav shadow">
                    <span class="child-nav-btn child-nav-btn-this">修改角色</span>
                </div>
				<div class="shadow" style="text-align:left;font-size:16px;padding:40px 240px;background:#fff;margin-bottom:15px;">
					<form action="${pageContext.request.contextPath}/role/update" method="post">
						<table class="layui-table" lay-size="lg" width="100%">
							<tr>
								<td>ID</td>
								<td><input class="layui-input" type="text" name="id" value="${role.id}" readonly="readonly"/></td>
							</tr>
							<tr>
								<td>角色名</td>
								<td><input class="layui-input" type="text" name="name" value="${role.name}"/></td>
							</tr>
							<tr>
								<td>描述</td>
								<td><input class="layui-input" type="text" name="description" value="${role.description}"/></td>
							</tr>
							<tr>
